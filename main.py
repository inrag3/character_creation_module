...
def attack(char_name: str, char_class: str) -> str:
    """Производит урон по противнику в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокирует урон в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбирает класс игрока относительно ввода."""
